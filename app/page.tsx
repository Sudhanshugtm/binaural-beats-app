    ...
    <div className="flex flex-col">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-b from-black to-gray-900">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-purple-500/30 to-blue-500/30 opacity-50" />
        </div>
        ...
        <div className="relative container mx-auto px-6 z-10">
          <div className="text-center max-w-4xl mx-auto">
            <div 
              className="inline-block mb-6 rounded-full border border-purple-500/30 bg-purple-500/10 px-3 py-1 text-sm backdrop-blur-xl hover:scale-105 transition-transform"
            >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button
                ...
                size="lg"
                className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-lg px-8 py-6 hover:scale-105 transition-transform"
              >
                Start Free Session
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="p-6 rounded-2xl bg-gradient-to-b from-gray-800/50 to-gray-900/50 border border-gray-800 hover:border-purple-500/50 transition-all duration-300 hover:-translate-y-1"
              >
      ...
      <section className="relative py-24 bg-black overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="relative z-10 bg-gradient-to-b from-gray-800/50 to-gray-900/50 p-12 md:p-20 rounded-3xl border border-gray-800 hover:border-purple-500/50 transition-all duration-300">
