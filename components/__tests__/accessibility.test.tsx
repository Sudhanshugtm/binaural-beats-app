...
import * as AccessibilityModule from '@/components/AccessibilityProvider'
...
describe('Accessibility Compliance Tests', () => {
  ...
  describe('Screen Reader Support', () => {
    ...
    it('should announce changes to screen readers', async () => {
      ...
      const useAccessibilitySpy = vi.spyOn(AccessibilityModule, 'useAccessibility').mockReturnValue({
        settings: {
          highContrast: false,
          fontSize: 'medium',
          reducedMotion: false,
      ...
      useAccessibilitySpy.mockRestore()
    })
